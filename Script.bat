...
ECHO * x    Batch Theme Image Transfer (Read the Instructions before using this feature)   *
ECHO *                                                                                     *
ECHO ***************************************************************************************
...
echo Make sure u include ur ApkMultiTool2.log, and if its not a editing problem i.e 
