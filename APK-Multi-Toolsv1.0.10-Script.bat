...
echo Zipping Apk
cd other
7za a -tzip "%~dp0place-apk-here-for-modding/unsigned_%capp%" "%~dp0projects/%capp%/*" -mx%usrc%
if errorlevel 1 (
...
cd other
echo Signing Apk
java -Xmx%heapy%m -jar signapk.jar -w testkey.x509.pem testkey.pk8 %~dp0place-apk-here-for-modding/unsigned_%capp% %~dp0place-apk-here-for-modding/signed_%capp%
if errorlevel 1 (
echo "An Error Occured, Please Check The Log (option 23)"
PAUSE
)
...
echo Pushing apk
"%~dp0other\adb.exe" push "%~dp0place-apk-here-for-modding\System_%capp%" "%INPUT%"
if errorlevel 1 (
echo "An Error Occured, Please Check The Log (option 23)"
PAUSE
)
...
java -Xmx%heapy%m -jar apktool.jar d %~dp0place-apk-here-for-modding/%capp% %~dp0projects/%capp%
if errorlevel 1 (
echo "An Error Occured, Please Check The Log (option 23)"
PAUSE
)
...
cd other
IF EXIST "%~dp0place-apk-here-for-modding\unsigned_%capp%" (del /Q "%~dp0place-apk-here-for-modding\unsigned_%capp%")
IF EXIST "%~dp0place-apk-here-for-modding\signed_%capp%" (del /Q "%~dp0place-apk-here-for-modding\signed_%capp%")
...
java -Xmx%heapy%m -jar apktool.jar b "%~dp0projects/%capp%" "%~dp0place-apk-here-for-modding\System_%capp%"
if (%jar%)==(0) (goto :nojar)
%szip% x -o "%~dp0projects/temp" "%~dp0place-apk-here-for-modding/%capp%" META-INF -r
%szip% a -tzip "%~dp0place-apk-here-for-modding/System_%capp%" "%~dp0projects/temp/*" -mx%usrc% -r
...
echo on this script.
PAUSE
7za a -tzip "%~dp0place-apk-here-for-modding/System_%capp%" "%~dp0keep/*" -mx%usrc% -r
rmdir /S /Q "%~dp0keep"
...
7za a -tzip "%~dp0place-apk-here-for-modding/System_%capp%" "%~dp0projects/temp/*" -mx%usrc% -r
...
if (%jar%)==(1) (echo Building Jar)
IF EXIST "%~dp0place-apk-here-for-modding\unsigned_%capp%" (del /Q "%~dp0place-apk-here-for-modding\unsigned_%capp%")
java -Xmx%heapy%m -jar apktool.jar b "%~dp0projects/%capp%" "%~dp0place-apk-here-for-modding\unsigned_%capp%"
if (%jar%)==(0) (goto :nojar2)
%szip% x -o "%~dp0projects/temp" "%~dp0place-apk-here-for-modding/%capp%" META-INF -r
%szip% a -tzip "%~dp0place-apk-here-for-modding/unsigned_%capp%" "%~dp0projects/temp/*" -mx%usrc% -r
rmdir /S /Q "%~dp0projects/temp"
goto restart
...
echo on this script.
PAUSE
7za a -tzip "%~dp0place-apk-here-for-modding/unsigned_%capp%" "%~dp0keep/*" -mx%usrc% -r
rmdir /S /Q "%~dp0keep"
cd ..
goto restart
:nq6
...
DEL "%~dp0place-apk-here-for-modding/unsigned_%capp%"
7za a -tzip "%~dp0place-apk-here-for-modding/signed_%capp%" "%~dp0keep/*" -mx%usrc% -r
rmdir /S /Q "%~dp0keep"
cd ..
goto restart
:nq8
...
DEL "%~dp0place-apk-here-for-modding/unsigned_%capp%"
7za x -o "%~dp0projects/temp" "%~dp0place-apk-here-for-modding/%capp%" META-INF -r
7za a -tzip "%~dp0place-apk-here-for-modding/signed_%capp%" "%~dp0projects/temp/*" -mx%usrc% -r
rmdir /S /Q "%~dp0projects/temp"
goto restart
:q1
